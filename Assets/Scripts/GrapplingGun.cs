...
public class GrapplingGun : MonoBehaviour
{
    ...
    private void Update()
    {
        bool leftMousePressedDown = Mouse.current.leftButton.wasPressedThisFrame;
        bool leftMousePressed = Mouse.current.leftButton.isPressed;
        bool leftMousePressedUp = Mouse.current.leftButton.wasReleasedThisFrame;
